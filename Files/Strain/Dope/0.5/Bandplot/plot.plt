...
EF = 12.1581
set yrange [-5:10]    # Adjust as needed
...
plot 'RuO2_bands-sp1.dat.gnu' using 1:(column(2) - EF) with lines lt 1 lw 1 lc rgb "red" title "QE up", \
	 ...
	 'RuO2_up_band.dat'  using (column(1)*4.5886/6.34971):(column(2) - EF) w lines lt 1 lw 1 dashtype 2 lc rgb "green" title "Wannier up",\
     'RuO2_dn_band.dat'   using (column(1)*4.5886/6.34971):(column(2) - EF) w lines lt 1 lw 1 dashtype 2 lc rgb "black" title "Wannier down"