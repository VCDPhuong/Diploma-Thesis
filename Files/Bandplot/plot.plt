...
plot 'RuO2_bands-sp1.dat.gnu' using 1:(column(2) - EF) with lines lt 1 lw 1 lc rgb "red" title "Spin up", \
	 ...
	 'RuO2_band.up.dat'       using (column(1)*4.5886/6.34971):(column(2) - EF) w l title "Wannier Spin up", \
	 'RuO2_band.down.dat'     using (column(1)*4.5886/6.34971):(column(2) - EF) w l title "Wannier Spin down"
