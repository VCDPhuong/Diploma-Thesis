...
outfile = 'RuO2-kslice-curv_x.pdf'
 
val = np.loadtxt('RuO2-kslice-curv.dat', usecols=(0,))
...
cbar.set_label('Berry Curvature (x-component)', fontsize=14, rotation=270, labelpad=20)
 
# Add title and improve overall appearance
pl.title('RuO2 K-slice Berry Curvature (x-component) with Fermi Lines', fontsize=16, pad=20)
